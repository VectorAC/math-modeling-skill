	...
	factory: (require) => {
		...
		const SKINS = [
		{
		  ...
		  "tokens": {
		    ...
		    "--dsw-alias-bg-base": "rgba(23, 22, 26, 0.76)",
		    "--dsw-alias-bg-layer-1": "rgba(35, 36, 41, 0.6)",
		    "--dsw-alias-bg-layer-2": "rgba(30, 30, 34, 0.5)",
		    "--dsw-alias-bg-layer-3": "rgba(28, 27, 32, 0.45)",
		    "--dsw-alias-bg-module-platform": "rgba(28, 27, 32, 0.5)",
		    "--dsw-alias-bg-overlay": "rgba(55, 55, 57, 0.55)",
		    "--dsw-alias-bg-multi-select": "rgba(55, 55, 57, 0.55)",
		    ...
		    "--dsw-alias-button-elevated-fill": "rgba(30, 30, 34, 0.75)",
		    "--dsw-alias-button-floating-fill": "rgba(55, 55, 57, 0.75)",
		    "--dsw-alias-button-floating-hover": "rgba(70, 70, 70, 0.55)",
		    "--dsw-alias-button-ghost-active-border": "#464646",
		    "--dsw-alias-button-ghost-active-fill": "rgba(30, 30, 34, 0.65)",
		    "--dsw-alias-button-ghost-active-hover": "rgba(55, 55, 57, 0.65)",
		    ...
		    "--dsw-alias-interactive-bg-hover-solid": "rgba(55, 55, 57, 0.8)",
		    ...
		    "--dsw-alias-markdown-citation": "rgba(55, 55, 57, 0.6)",
		    "--dsw-alias-markdown-code-block": "rgba(30, 30, 34, 0.55)",
		    "--dsw-alias-markdown-code-block-banner": "rgba(35, 36, 41, 0.55)",
		    "--dsw-alias-markdown-code-segment-selected": "rgba(55, 55, 57, 0.6)",
		    "--dsw-alias-markdown-code-segment-unselected": "rgba(30, 30, 34, 0.55)",
		    "--dsw-alias-markdown-inline-code": "rgba(55, 55, 57, 0.6)",
		    ...
		    "--dsw-alias-toast-bg": "rgba(30, 30, 34, 0.75)",
		    "--dsw-alias-tooltip-bg": "rgba(55, 55, 57, 0.8)",
		    "--dsw-specific-sidebar-fill": "rgba(23, 22, 26, 0.72)",
		    "--dsw-specific-sidebar-nav-item-active": "rgba(55, 55, 57, 0.65)",
		    "--dsw-specific-sidebar-nav-item-active-accent": "rgba(95, 141, 110, 0.25)",
		    "--dsw-specific-sidebar-nav-item-hover": "rgba(30, 30, 34, 0.55)",
		    "--dsw-specific-bubble": "rgba(30, 30, 34, 0.6)",
		    "--dsw-specific-bubble-highlight": "rgba(55, 55, 57, 0.6)",
		    "--dsw-specific-input-major": "rgba(23, 22, 26, 0.72)",
		    "--dsw-specific-login-input": "rgba(23, 22, 26, 0.72)",
		    "--dsw-specific-menu": "rgba(30, 30, 34, 0.65)",
		    "--dsw-specific-selector": "rgba(55, 55, 57, 0.6)",
		    "--dsw-specific-tip": "rgba(30, 30, 34, 0.6)",
		    "--shiki-background": "rgba(30, 30, 34, 0.55)",
		...
		},
		{
		  ...
		  "tokens": {
		    ...
		    "--dsw-alias-bg-base": "rgba(14, 19, 38, 0.76)",
		    "--dsw-alias-bg-layer-1": "rgba(26, 33, 56, 0.6)",
		    "--dsw-alias-bg-layer-2": "rgba(21, 27, 48, 0.5)",
		    "--dsw-alias-bg-layer-3": "rgba(19, 24, 45, 0.45)",
		    "--dsw-alias-bg-module-platform": "rgba(19, 24, 45, 0.5)",
		    "--dsw-alias-bg-overlay": "rgba(45, 53, 75, 0.55)",
		    "--dsw-alias-bg-multi-select": "rgba(45, 53, 75, 0.55)",
		    ...
		    "--dsw-alias-button-elevated-fill": "rgba(21, 27, 48, 0.75)",
		    "--dsw-alias-button-floating-fill": "rgba(45, 53, 75, 0.75)",
		    "--dsw-alias-button-floating-hover": "rgba(61, 69, 90, 0.55)",
		    "--dsw-alias-button-ghost-active-border": "#3d455a",
		    "--dsw-alias-button-ghost-active-fill": "rgba(21, 27, 48, 0.65)",
		    "--dsw-alias-button-ghost-active-hover": "rgba(45, 53, 75, 0.65)",
		    ...
		    "--dsw-alias-interactive-bg-hover-solid": "rgba(45, 53, 75, 0.8)",
		    ...
		    "--dsw-alias-markdown-citation": "rgba(45, 53, 75, 0.6)",
		    "--dsw-alias-markdown-code-block": "rgba(21, 27, 48, 0.55)",
		    "--dsw-alias-markdown-code-block-banner": "rgba(26, 33, 56, 0.55)",
		    "--dsw-alias-markdown-code-segment-selected": "rgba(45, 53, 75, 0.6)",
		    "--dsw-alias-markdown-code-segment-unselected": "rgba(21, 27, 48, 0.55)",
		    "--dsw-alias-markdown-inline-code": "rgba(45, 53, 75, 0.6)",
		    ...
		    "--dsw-alias-toast-bg": "rgba(21, 27, 48, 0.75)",
		    "--dsw-alias-tooltip-bg": "rgba(45, 53, 75, 0.8)",
		    "--dsw-specific-sidebar-fill": "rgba(14, 19, 38, 0.72)",
		    "--dsw-specific-sidebar-nav-item-active": "rgba(45, 53, 75, 0.65)",
		    "--dsw-specific-sidebar-nav-item-active-accent": "rgba(43, 74, 143, 0.25)",
		    "--dsw-specific-sidebar-nav-item-hover": "rgba(21, 27, 48, 0.55)",
		    "--dsw-specific-bubble": "rgba(21, 27, 48, 0.6)",
		    "--dsw-specific-bubble-highlight": "rgba(45, 53, 75, 0.6)",
		    "--dsw-specific-input-major": "rgba(14, 19, 38, 0.72)",
		    "--dsw-specific-login-input": "rgba(14, 19, 38, 0.72)",
		    "--dsw-specific-menu": "rgba(21, 27, 48, 0.65)",
		    "--dsw-specific-selector": "rgba(45, 53, 75, 0.6)",
		    "--dsw-specific-tip": "rgba(21, 27, 48, 0.6)",
		    "--shiki-background": "rgba(21, 27, 48, 0.55)",
		...
		},
		{
		  ...
		  "tokens": {
		    ...
		    "--dsw-alias-bg-base": "rgba(13, 13, 19, 0.76)",
		    "--dsw-alias-bg-layer-1": "rgba(26, 26, 34, 0.6)",
		    "--dsw-alias-bg-layer-2": "rgba(20, 20, 27, 0.5)",
		    "--dsw-alias-bg-layer-3": "rgba(18, 18, 25, 0.45)",
		    "--dsw-alias-bg-module-platform": "rgba(18, 18, 25, 0.5)",
		    "--dsw-alias-bg-overlay": "rgba(45, 45, 53, 0.55)",
		    "--dsw-alias-bg-multi-select": "rgba(45, 45, 53, 0.55)",
		    ...
		    "--dsw-alias-button-elevated-fill": "rgba(20, 20, 27, 0.75)",
		    "--dsw-alias-button-floating-fill": "rgba(45, 45, 53, 0.75)",
		    "--dsw-alias-button-floating-hover": "rgba(60, 60, 68, 0.55)",
		    "--dsw-alias-button-ghost-active-border": "#3c3c44",
		    "--dsw-alias-button-ghost-active-fill": "rgba(20, 20, 27, 0.65)",
		    "--dsw-alias-button-ghost-active-hover": "rgba(45, 45, 53, 0.65)",
		    ...
		    "--dsw-alias-interactive-bg-hover-solid": "rgba(45, 45, 53, 0.8)",
		    ...
		    "--dsw-alias-markdown-citation": "rgba(45, 45, 53, 0.6)",
		    "--dsw-alias-markdown-code-block": "rgba(20, 20, 27, 0.55)",
		    "--dsw-alias-markdown-code-block-banner": "rgba(26, 26, 34, 0.55)",
		    "--dsw-alias-markdown-code-segment-selected": "rgba(45, 45, 53, 0.6)",
		    "--dsw-alias-markdown-code-segment-unselected": "rgba(20, 20, 27, 0.55)",
		    "--dsw-alias-markdown-inline-code": "rgba(45, 45, 53, 0.6)",
		    ...
		    "--dsw-alias-state-warn-secondary": "rgba(201, 162, 39, 0.16)",
		    "--dsw-alias-state-warn-tertiary": "rgba(201, 162, 39, 0.1)",
		    "--dsw-alias-toast-bg": "rgba(20, 20, 27, 0.75)",
		    "--dsw-alias-tooltip-bg": "rgba(45, 45, 53, 0.8)",
		    "--dsw-specific-sidebar-fill": "rgba(13, 13, 19, 0.72)",
		    "--dsw-specific-sidebar-nav-item-active": "rgba(45, 45, 53, 0.65)",
		    "--dsw-specific-sidebar-nav-item-active-accent": "rgba(59, 91, 143, 0.25)",
		    "--dsw-specific-sidebar-nav-item-hover": "rgba(20, 20, 27, 0.55)",
		    "--dsw-specific-bubble": "rgba(20, 20, 27, 0.6)",
		    "--dsw-specific-bubble-highlight": "rgba(45, 45, 53, 0.6)",
		    "--dsw-specific-input-major": "rgba(13, 13, 19, 0.72)",
		    "--dsw-specific-login-input": "rgba(13, 13, 19, 0.72)",
		    "--dsw-specific-menu": "rgba(20, 20, 27, 0.65)",
		    "--dsw-specific-selector": "rgba(45, 45, 53, 0.6)",
		    "--dsw-specific-tip": "rgba(20, 20, 27, 0.6)",
		    "--shiki-background": "rgba(20, 20, 27, 0.55)",
		...
		},
		{
		  ...
		  "tokens": {
		    ...
		    "--dsw-alias-bg-base": "rgba(21, 21, 26, 0.76)",
		    "--dsw-alias-bg-layer-1": "rgba(33, 33, 41, 0.6)",
		    "--dsw-alias-bg-layer-2": "rgba(28, 28, 34, 0.5)",
		    "--dsw-alias-bg-layer-3": "rgba(26, 26, 32, 0.45)",
		    "--dsw-alias-bg-module-platform": "rgba(26, 26, 32, 0.5)",
		    "--dsw-alias-bg-overlay": "rgba(53, 53, 59, 0.55)",
		    "--dsw-alias-bg-multi-select": "rgba(53, 53, 59, 0.55)",
		    ...
		    "--dsw-alias-button-elevated-fill": "rgba(28, 28, 34, 0.75)",
		    "--dsw-alias-button-floating-fill": "rgba(53, 53, 59, 0.75)",
		    "--dsw-alias-button-floating-hover": "rgba(69, 68, 73, 0.55)",
		    "--dsw-alias-button-ghost-active-border": "#454449",
		    "--dsw-alias-button-ghost-active-fill": "rgba(28, 28, 34, 0.65)",
		    "--dsw-alias-button-ghost-active-hover": "rgba(53, 53, 59, 0.65)",
		    ...
		    "--dsw-alias-interactive-bg-hover-solid": "rgba(53, 53, 59, 0.8)",
		    ...
		    "--dsw-alias-markdown-citation": "rgba(53, 53, 59, 0.6)",
		    "--dsw-alias-markdown-code-block": "rgba(28, 28, 34, 0.55)",
		    "--dsw-alias-markdown-code-block-banner": "rgba(33, 33, 41, 0.55)",
		    "--dsw-alias-markdown-code-segment-selected": "rgba(53, 53, 59, 0.6)",
		    "--dsw-alias-markdown-code-segment-unselected": "rgba(28, 28, 34, 0.55)",
		    "--dsw-alias-markdown-inline-code": "rgba(53, 53, 59, 0.6)",
		    ...
		    "--dsw-alias-state-warn-secondary": "rgba(201, 162, 39, 0.16)",
		    "--dsw-alias-state-warn-tertiary": "rgba(201, 162, 39, 0.1)",
		    "--dsw-alias-toast-bg": "rgba(28, 28, 34, 0.75)",
		    "--dsw-alias-tooltip-bg": "rgba(53, 53, 59, 0.8)",
		    "--dsw-specific-sidebar-fill": "rgba(21, 21, 26, 0.72)",
		    "--dsw-specific-sidebar-nav-item-active": "rgba(53, 53, 59, 0.65)",
		    "--dsw-specific-sidebar-nav-item-active-accent": "rgba(166, 58, 58, 0.25)",
		    "--dsw-specific-sidebar-nav-item-hover": "rgba(28, 28, 34, 0.55)",
		    "--dsw-specific-bubble": "rgba(28, 28, 34, 0.6)",
		    "--dsw-specific-bubble-highlight": "rgba(53, 53, 59, 0.6)",
		    "--dsw-specific-input-major": "rgba(21, 21, 26, 0.72)",
		    "--dsw-specific-login-input": "rgba(21, 21, 26, 0.72)",
		    "--dsw-specific-menu": "rgba(28, 28, 34, 0.65)",
		    "--dsw-specific-selector": "rgba(53, 53, 59, 0.6)",
		    "--dsw-specific-tip": "rgba(28, 28, 34, 0.6)",
		    "--shiki-background": "rgba(28, 28, 34, 0.55)",
		...
		},
		{
		  ...
		  "tokens": {
		    ...
		    "--dsw-alias-bg-base": "rgba(5, 7, 15, 0.76)",
		    "--dsw-alias-bg-layer-1": "rgba(16, 20, 31, 0.6)",
		    "--dsw-alias-bg-layer-2": "rgba(11, 14, 24, 0.5)",
		    "--dsw-alias-bg-layer-3": "rgba(9, 12, 21, 0.45)",
		    "--dsw-alias-bg-module-platform": "rgba(9, 12, 21, 0.5)",
		    "--dsw-alias-bg-overlay": "rgba(34, 39, 50, 0.55)",
		    "--dsw-alias-bg-multi-select": "rgba(34, 39, 50, 0.55)",
		    ...
		    "--dsw-alias-button-elevated-fill": "rgba(11, 14, 24, 0.75)",
		    "--dsw-alias-button-floating-fill": "rgba(34, 39, 50, 0.75)",
		    "--dsw-alias-button-floating-hover": "rgba(49, 54, 66, 0.55)",
		    "--dsw-alias-button-ghost-active-border": "#313642",
		    "--dsw-alias-button-ghost-active-fill": "rgba(11, 14, 24, 0.65)",
		    "--dsw-alias-button-ghost-active-hover": "rgba(34, 39, 50, 0.65)",
		    ...
		    "--dsw-alias-interactive-bg-hover-solid": "rgba(34, 39, 50, 0.8)",
		    ...
		    "--dsw-alias-markdown-citation": "rgba(34, 39, 50, 0.6)",
		    "--dsw-alias-markdown-code-block": "rgba(11, 14, 24, 0.55)",
		    "--dsw-alias-markdown-code-block-banner": "rgba(16, 20, 31, 0.55)",
		    "--dsw-alias-markdown-code-segment-selected": "rgba(34, 39, 50, 0.6)",
		    "--dsw-alias-markdown-code-segment-unselected": "rgba(11, 14, 24, 0.55)",
		    "--dsw-alias-markdown-inline-code": "rgba(34, 39, 50, 0.6)",
		    ...
		    "--dsw-alias-toast-bg": "rgba(11, 14, 24, 0.75)",
		    "--dsw-alias-tooltip-bg": "rgba(34, 39, 50, 0.8)",
		    "--dsw-specific-sidebar-fill": "rgba(5, 7, 15, 0.72)",
		    "--dsw-specific-sidebar-nav-item-active": "rgba(34, 39, 50, 0.65)",
		    "--dsw-specific-sidebar-nav-item-active-accent": "rgba(63, 127, 255, 0.25)",
		    "--dsw-specific-sidebar-nav-item-hover": "rgba(11, 14, 24, 0.55)",
		    "--dsw-specific-bubble": "rgba(11, 14, 24, 0.6)",
		    "--dsw-specific-bubble-highlight": "rgba(34, 39, 50, 0.6)",
		    "--dsw-specific-input-major": "rgba(5, 7, 15, 0.72)",
		    "--dsw-specific-login-input": "rgba(5, 7, 15, 0.72)",
		    "--dsw-specific-menu": "rgba(11, 14, 24, 0.65)",
		    "--dsw-specific-selector": "rgba(34, 39, 50, 0.6)",
		    "--dsw-specific-tip": "rgba(11, 14, 24, 0.6)",
		    "--shiki-background": "rgba(11, 14, 24, 0.55)",
