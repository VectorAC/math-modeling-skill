...
每套皮肤 = 原生 token 全配色 + 专属水墨/星野壁纸（内置生成 SVG）+ 毛玻璃面板（透明度可拖滑块自调），内置皮肤切换器随时对比，支持上传自定义壁纸（自动 Ken Burns 推拉模拟动态壁纸），带墨滴/星光特效与发送涟漪。
...
| 皮肤 | 底色 | 身份色 | 壁纸意象 | 特效 |
|---|---|---|---|---|
| 剑来 | `#17161a` | 竹青 `#5f8d6e` · 朱砂 `#b03a2e` · 鎏金 `#c9a227` | 烟雨青山水墨 + 印章 | 墨滴 + 光尘 |
| 沧元图 | `#0e1326` | 群青 `#2b4a8f` · 灵光青白 `#9fd8ff` | 泼墨灵光 + 印章 | 墨滴 + 光尘 |
| 斩神 | `#0d0d13` | 幽蓝封印 `#3b5b8f` · 血红 `#a12622` | 夜城血月 + 印章 | 墨滴 + 光尘 |
| 不良人 | `#15151a` | 绯红 `#a63a3a` · 鎏金 `#c9a227` · 暗青 `#45607a` | 唐楼月夜 + 印章 | 墨滴 + 光尘 |
| 吞噬星空 | `#05070f` | 能量蓝 `#3f7fff` · 霓虹紫 `#8a5cff` | 星云机甲 + 印章 | 墨滴 + 光尘 |
| 二次元星空 | `#0a0e1a` | 星紫 `#7b6cf6` · 星青 `#5ec8ff` · 星光金 `#ffd86b` | 星野星云 + 弯月 + 流星拖尾 | 星星闪烁 + 流星 |
